...
const CreateSnippet = () => {
  ...
  return (
   ...
   <div style={{backgroundColor:"#afd3de"}} className="card  text-center text-black">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          <label style={{paddingTop:"7px"}} htmlFor="title" className="form-label">
            Title:
          </label>
          <input
            type="text"
        ...
        <button style={{backgroundColor:"#132b33"}} type="submit" className="btn btn-primary">
          Create Snippet
        </button>
      </form>
